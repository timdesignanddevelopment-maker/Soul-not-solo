  ...
  return (
    ...
    >
      ...
      <View style={styles.footer}>
        ...
        <Ionicons name="arrow-forward-circle-outline" size={16} color={colors.parchmentTextMuted} />
      </View>
    </Pressable>
  );
}
...
const createStyles = (colors: ThemeColors) =>
  StyleSheet.create({
    ...
    reference: {
      ...
      fontSize: 30,
      color: colors.parchmentTextMuted,
      textAlign: "center",
    },
    verse: {
