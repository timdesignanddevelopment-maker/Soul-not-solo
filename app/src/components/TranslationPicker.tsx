            ...
            <FlatList
              ...
              renderItem={({ item }) => (
                ...
                >
                  ...
                  {item.id === selectedId ? <Ionicons name="checkmark" size={18} color={colors.accent} /> : null}
                </Pressable>
              )}
            />
          </View>
...
const createStyles = (colors: ThemeColors) =>
  StyleSheet.create({
    ...
    triggerText: { fontFamily: FONT_SERIF_BOLD, fontSize: 13, color: colors.accent, letterSpacing: 0.5 },
    backdrop: {
      flex: 1,
    ...
    rowText: { fontFamily: FONT_SERIF_BOLD, fontSize: 15, color: colors.textMuted },
